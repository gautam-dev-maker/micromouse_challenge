...
# from pkg_tf_micromouse.cfg import FollowerConfig
...
class WallFollowerHusky:
    def __init__(self):
        ...
        self.forward_speed = 0.1 #rospy.get_param("~forward_speed")
        self.desired_distance_from_wall = 0.08 #rospy.get_param("~desired_distance_from_wall")
        self.hz = 50 
        ...
        self.laser_sub = rospy.Subscriber("/my_mm_robot/laser/scan", LaserScan, self.laser_scan_callback)
    ...
    def laser_scan_callback(self, msg):
        ...
        print(self.controller.get_control())
